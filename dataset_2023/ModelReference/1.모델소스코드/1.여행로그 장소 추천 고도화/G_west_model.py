...
visit_G = pd.read_csv('../1.inputdata/tn_visit_area_info_G.csv')
...
df1.to_csv("../2.preprocessed/dfG.csv")
...
file_path = '../4.SaveModel/model/svd_model_G.pkl'
# Save the model to the specified .pkl file
with open(file_path, 'wb') as file:
    pickle.dump(algo, file)

loaded_model1 = joblib.load('../4.SaveModel/model/svd_model_G.pkl')
...
df_G_final.to_csv('../4.SaveModel/result/testset_output/G_test_ouput.csv')
...
filtered_top_recommendations.to_csv('../4.SaveModel/result/final_output/G_top_recommendations.csv')
